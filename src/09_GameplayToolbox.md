...
**Fatigue.** The creature gains 1 Exhaustion level. **Weakness.** While the creature has any Exhaustion levels, it regains only half the normal number of

Hit Points from spending Hit Point Dice. **Restlessness.** While the creature has any Exhaustion levels, finishing a Long Rest neither restores lost Hit Points nor reduces the creature's Exhaustion level.
...
# **Environmental Effects Deep Water**
...
- a favorite tool among assassins and evil creatures. Poisons come in the following four types:
